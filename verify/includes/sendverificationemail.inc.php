...
if (isset($_POST['verifysubmit'])) {
    ...
    */
    ...
    $url = ( (isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == 'on') ? 'https://' : 'http://' ) . $_SERVER['HTTP_HOST'] . dirname($_SERVER['PHP_SELF']) . "/verify.inc.php?selector=" . $selector . "&validator=" . bin2hex($token);
    ...
    */
    ...
    try {
        ...
        // for public use
        $_SESSION['STATUS']['verify'] = 'email could not be sent, try again later' . $e . "<br><br>" . $message;
